...
module.exports = {
  ...
  plugins: [
    ...
    postcssPresetEnv({
      // stage选项根据CSS特性在成为实现的web标准过程中的稳定性来确定要填充哪些CSS特性。
      stage: 3,
      // features选项按ID启用或禁用特定的polyfill,参考：https://github.com/csstools/postcss-plugins/blob/main/plugin-packs/postcss-preset-env/FEATURES.md
      features: {
        // 该语法在草案阶段(stage: 0)
